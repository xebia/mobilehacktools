...
- Lastly, it could be the case when you are testing this on a separate account, which does not have the correct rights for the brew folders. See Issue #30 reported by [@TheDauntless](https://github.com/TheDauntless). When you are on High Sierra you need to do:
